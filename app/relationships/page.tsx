        ...
        {loadingRelationships || loadingCompanyDetails ? (
          ...
          <div className="relative p-6 bg-gradient-to-b from-white to-gray-50/60" style={{ minHeight: `${mapBodyHeight}px` }}>
            <div className="relative flex">
              <div className="w-[250px] flex items-start justify-center pt-8">
                <div className="w-[210px] rounded-xl border border-gray-200 bg-white shadow-sm p-4">
              ...
              <div className="flex-1 ml-8 space-y-6 py-4">
                {mapNodes.map((node) => (
                  <div key={node.repId} className="grid grid-cols-1 xl:grid-cols-[240px_minmax(0,1fr)] gap-4 items-start">
                    <div className="border border-gray-200 rounded-lg overflow-hidden bg-white">
